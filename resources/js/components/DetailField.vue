    ...
    <PanelItem :index="index" :field="field">
        <template #value>
            <div v-if="field.value">
                <a class="no-underline dim text-primary font-semibold" :href="field.value" target="_blank">
                    <div class="flex items-center">
                        <svg class="fill-current w-4 h-4 mr-2 text-60" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 576 512">
